...
func (a *VulnerabilitiesApiService) GetImageVulnerabilitiesByType(ctx context.Context, imageDigest string, vtype string, localVarOptionals map[string]interface{}) (VulnerabilityList,  *http.Response, error) {
	var (
