...
// APIClient manages communication with the Anchore Engine API Server API v0.1.5
...
type APIClient struct {
	...
	ImageTagsApi        *ImageTagsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ImageTagsApi = (*ImageTagsApiService)(&c.common)
